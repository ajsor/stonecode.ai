      ...
      >
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-slate-400">Manage feature toggles for users</p>
          </div>
          <button
        ...
        {showCreateForm && (
          <motion.div
            className="p-6 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-xl mb-6"
            initial={{ opacity: 0, y: -10 }}
            animate={{ opacity: 1, y: 0 }}
          >
            ...
            <form onSubmit={handleCreateFeature}>
              <div className="space-y-4">
                ...
                <button
                  type="submit"
                  disabled={isCreating}
                  className="w-full py-3 rounded-xl bg-gradient-to-r from-violet-600 to-blue-600 text-white font-medium hover:from-violet-500 hover:to-blue-500 transition-all disabled:opacity-50"
                >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                      ...
                      <svg
                        className={`w-5 h-5 ${feature.enabled_default ? 'text-green-400' : 'text-slate-500'}`}
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24"
                      >
                    ...
                    <div>
                      <p className="text-white font-medium font-mono">{feature.name}</p>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <button
                      ...
                      className={`relative w-12 h-6 rounded-full transition-colors ${
                        feature.enabled_default ? 'bg-green-500' : 'bg-slate-700'
                      }`}
                    >
                      <span
