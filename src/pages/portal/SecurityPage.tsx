    ...
    <div className="max-w-2xl mx-auto">
      ...
      >
        ...
        <div className="flex items-center gap-2 text-sm mb-6">
          <Link to="/portal/profile" className="text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white transition-colors">
            Profile
          </Link>
        ...
        <p className="text-slate-500 dark:text-slate-400 mb-8">Manage your authentication methods</p>
          ...
          {!webauthnSupported ? (
            ...
            <>
              {isLoadingPasskeys ? (
                ...
                <div className="space-y-3 mb-6">
                  {passkeys.map((passkey) => (
                    <div
                      key={passkey.id}
                      className="flex items-center justify-between p-4 rounded-xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10"
                    >
                      <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="w-full py-3 px-4 rounded-xl font-medium text-white bg-gradient-to-r from-orange-500 to-amber-500 hover:from-orange-400 hover:to-amber-400 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isRegistering ? (
        ...
        {/* MFA Section */}
        <div className="p-6 rounded-2xl bg-white dark:bg-white/5 border border-slate-200 dark:border-white/10 backdrop-blur-xl">
          <div className="flex items-center gap-3 mb-6">
          ...
          <div className="p-4 rounded-xl bg-slate-50 dark:bg-slate-800/50 border border-slate-100 dark:border-white/5 mb-4">
            <div className="flex items-center gap-3">
