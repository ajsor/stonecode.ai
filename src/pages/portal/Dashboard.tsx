      ...
      >
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 text-slate-300 hover:bg-white/10 hover:text-white transition-colors"
          >
        ...
        <div className="grid gap-6 md:grid-cols-3">
            ...
            {enabledFeatures.length > 0 ? (
              <div className="flex flex-wrap gap-1.5">
                {enabledFeatures.slice(0, 3).map(([name]) => (
                  <span
                    key={name}
                    className="px-2 py-0.5 rounded-full bg-violet-500/20 text-violet-400 text-xs font-medium"
                  >
                    {name.replace(/_/g, ' ')}
                  </span>
                ))}
          ...
          >
            ...
            <div className="flex gap-2">
              <a
                href="/portal/profile"
                className="flex-1 px-3 py-2 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition-colors text-center text-xs text-slate-300 hover:text-white"
              >
                Profile
              </a>
              <a
