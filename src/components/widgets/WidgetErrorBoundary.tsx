...
export class WidgetErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      return (
        <div className="h-full flex flex-col rounded-2xl bg-white/5 border border-red-500/20 backdrop-blur-xl overflow-hidden">
          <div className="flex items-center gap-2 px-4 py-3 border-b border-white/10">
            ...
            <h3 className="text-sm font-medium text-white">{this.props.widgetName}</h3>
          </div>
