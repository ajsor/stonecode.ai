      ...
      <div className="flex flex-col">
        {!hasTarget ? (
          ...
          <div className="text-center">
            ...
            <div className="text-xl font-bold text-slate-900 dark:text-white mb-1">{eventName}</div>
            <div className="text-emerald-600 dark:text-emerald-400 font-medium">Event has arrived!</div>
          </div>
        ) : (
          <>
            {/* Event name */}
            <div className="text-center mb-4">
              <div className="text-lg font-semibold text-slate-900 dark:text-white">{eventName}</div>
