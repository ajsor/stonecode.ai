...
export function WidgetContainer({
  ...
  // Measure content and report needed height for auto-sizing
  useEffect(() => {
    if (isCollapsed || isLoading || !contentRef.current) return
    collapseCtx?.reportContentHeight(contentRef.current.offsetHeight)
  }, [isCollapsed, isLoading, collapseCtx])
